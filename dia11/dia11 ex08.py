...
def most_spoken_languages(total):
    total_lenguajes = set()
    ...
    for i in range(total):
        lista.append(lenguajes[i]) 
    return lista

print(most_spoken_languages(15))

def most_populated_countries(total):
...
print(most_populated_countries(15))

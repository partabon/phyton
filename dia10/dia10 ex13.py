...
#crea un conjunto con todos los lenguajes únicos
total_lenguajes = set()
for pais in countries_data:
    total_lenguajes.update(pais["languages"])

#print(total_lenguajes)
print('Hay', len(total_lenguajes),'lenguajes en el mundo')
...
#crearemos dos listas, una con lenguajes y la otra con valores
lenguajes=list()
valores=list()
i=0
...
#imprime los 10 lenguajes que se hablan en el mayor número de países
for i in range(10):
    print(i+1,'.- Países:',valores[i],', lenguaje:',lenguajes[i]) 
...
#imprime los 10 países más poblados
for i in range(10):
    val = '{:,}'.format(valores[i])
    print(i+1,'.- Población:',val,'País:',paises[i]) 
